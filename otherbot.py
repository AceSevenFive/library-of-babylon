...
async def on_message(message):
	if message.content.startswith('%test'):
		...
		if tmp == "shownationstats":
			await client.send_message(message.author, "**shownationstats**:" + "\n" + "**DESCRIPTION:** Allows you to view the stats for a nation." + "\n" + "**USAGE:** %shownationstats [nation]")
client.run('MjUxMTAyMTAxNTM3NTU0NDMy.Cxeh0w.mng9SySK6ZH_CDlTS5YWGP8TnU4')